...
//Light.target.position.set(light.position);
...
light.shadow.mapSize.width = 300;
light.shadow.mapSize.height = 300;
...
var cameraWorld = {type: "mat4", value: camera.matrixWorld};
...
//Q1 Answer
//add the doubleSide and uniform of map,normalMap and aoMap
//here map == colorMap
...
//Q2 Answer:
//pass theblinn-phong uniforms
//and there is to uniform of MAP
...
var skyboxUniform = { type: "t", value: skyboxCubemap } ;
...
var envmapMaterial = new THREE.ShaderMaterial({
    uniforms:{
      ...
      //cameraPos: { type: "v4", value: camera.matrixWorld},
      CameraMatrixWorld:cameraWorld
    }
});
...
//BoxGeometry,skyboxMaterial
var boxGeometry = new THREE.BoxGeometry(1000,1000,1000);
var skybox = new THREE.Mesh(boxGeometry,skyboxMaterial);
scene.add(skybox);
